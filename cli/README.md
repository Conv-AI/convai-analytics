...
The CLI is a thin wrapper. For agent workflows, prefer [`@convai/analytics-mcp`](https://www.npmjs.com/package/@convai/analytics-mcp); for custom application code, prefer the SDK directly.
